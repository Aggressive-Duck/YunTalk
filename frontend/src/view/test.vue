    ...
    <div class="h-1/2 w-full bg-white">
      <div class="flex w-[1000px] mt-8  mx-auto">
        ...
        <button onclick="my_modal_1.showModal()"
          class="group px-4 ms-2 bg-[#042A2B] cursor-pointer transition-all ease-in-out  hover:bg-[#031b1c] text-white rounded-lg flex items-center justify-center">
          <Plus class="w-4 h-4 transition-all duration-500 group-hover:mr-2" />
          <span
            class="whitespace-nowrap overflow-hidden max-w-0 group-hover:max-w-[200px] transition-all duration-500 ease-in-out">新增評分</span>
        </button>
            ...
            <div class="w-3/5 p-6 text-black bg-white">
              <form @submit.prevent="submitForm" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                  ...
                  <textarea v-model="content" type="text" placeholder=""
                ...
                <div class="mb-4">
                  ...
                  <input type="file" @change="onFileChange"
                    class=" transition-all ease-in-out file-input file-input-[#042A2B] bg-gray-100  rounded-lg  hover:border-[#042A2B] hover:ring-1"
                    accept="image/*" />
                </div>
                <div class="flex justify-end">
                  <button type="submit"
                    class="bg-[#042A2B] cursor-pointer transition-all ease-in-out text-white rounded-lg text-[14px] mt-9 w-[100px] px-4 py-2 rounded">新增</button>
                </div>
              </form>
      ...
      <div class="w-[1000px] mx-auto mt-6 flex gap-6 text-black">
        ...
        <div class="w-1/4">
          <ul class="space-y-2 ">
            <li>
              <a href="#"
                class="flex items-center gap-3 px-3 py-2 transition-all ease-in-out text-[14px] bg-gray-200 rounded hover:bg-gray-200">
                <ChartPie class="w-4 h-4" />最新
              </a>
            </li>
            <li><a href="#"
                class="flex items-center gap-3 px-3 py-2 transition-all ease-in-out text-[14px] rounded hover:bg-gray-100">
                <GraduationCap class="w-4 h-4" />老師
              </a></li>
            <li><a href="#"
                class="flex items-center gap-3 px-3 py-2 transition-all ease-in-out text-[14px] rounded hover:bg-gray-100">
                <BookOpen class="w-4 h-4" />課程
              </a></li>
            <li><a href="#"
                class="flex items-center gap-3 px-3 py-2 transition-all ease-in-out text-[14px] rounded hover:bg-gray-100">
                <Toilet class="w-4 h-4" />廁所
              </a></li>
            <li><a href="#"
                class="flex items-center gap-3 px-3 py-2 transition-all ease-in-out text-[14px] rounded hover:bg-gray-100">
                <Speech class="w-4 h-4" />八卦
              </a></li>
          </ul>
        </div>
        ...
        <div class="flex-1 space-y-4">
          ...
          <div v-for="rating in ratings" :key="rating.id" @click="openDetail(rating.id)"
            class="bg-white rounded-lg p-2 flex gap-4 hover:bg-gray-100 cursor-pointer transition-all ease-in-out">
            <!-- 左邊圖片 -->
