  ...
  <div class="min-h-screen flex flex-col font-[System] bg-white">
    ...
    <div class="h-1/2 w-full bg-white">
        <div class="flex w-[1000px] mt-8  mx-auto">
            ...
            <!-- 搜尋按鈕 -->
            <button class="group px-4 ms-2 bg-[#042A2B] cursor-pointer transition-all ease-in-out  hover:bg-[#031b1c] text-white rounded-lg flex items-center justify-center">
